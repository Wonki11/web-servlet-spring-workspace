...
public class ExampleServlet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		httpServletRequest 
			...
			- 요청시 전달된 테이터, 요청한 클라이언트 정보, 요청을 유연하게 처리하기 위한 객체 등을 제공 
		...
		httpServletResponse 
			...
			--> 제출된 이름, 나이 = 전달 매개변수(Parameter) == 중간에 개입해서 전달되는 변수 전달된 값 보여줄 것 
		 ...
		 * */
		// <input type ="text" name="inputName"> 작성되어 제출된 값 얻어오기
		...
		StringBuilder sb = new StringBuilder();
			...
			sb.append("<head>");
			sb.append("<titel> /ex1 응답페이지 </title>");
			sb.append("</head>");
